...
let ImportedJobsRoutingModule = class ImportedJobsRoutingModule {
};
...
let ImportedJobsComponent = class ImportedJobsComponent {
    constructor() { }
    ngOnInit() {
        console.log('here');
    }
...
let ImportedJobsModule = class ImportedJobsModule {
};
...
let CompanyDetailedModalComponent = class CompanyDetailedModalComponent {
    ...
    ngOnInit() {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["forkJoin"])(this.salesService
            ...
            .getCompanyComments(this.companyId)).subscribe(([comp, comments]) => { this.comments = comments['comments']; this.company = comp; console.log(comp); });
    }
    ;
    openModal(type) {
        this.modalType = type;
...
CompanyDetailedModalComponent.ctorParameters = () => [
...
let ContactPersonModalComponent = class ContactPersonModalComponent {
    ...
    ngOnInit() {
        ...
        this.salesService.getCountries()
            .subscribe((contries) => this.listOfCountries = contries);
    }
    ...
    save() {
        ...
        this.salesService
            .editCompanyContactInfo(this.data._id, Object.assign({}, this.contactForm.value, { birthday }))
            .subscribe(() => this.close(), (err) => console.log(err), () => this.close());
    }
    ;
};
ContactPersonModalComponent.ctorParameters = () => [
...
let EditCompnayDetailedModalComponent = class EditCompnayDetailedModalComponent {
    constructor(fb, salesService) {
        this.fb = fb;
        this.salesService = salesService;
        this.result = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        ...
        this.searchCity = (text$) => text$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(200), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((term) => term.length > 1 ? this.getCities(term) : []));
        this.cityFormatter = (city) => city.city;
    ...
    ngOnInit() {
        ...
        this.salesService.getIndustries()
            .subscribe((industries) => this.listOfIndustries = industries);
        this.patchData();
    }
    ;
    patchData() {
    ...
    close() { this.result.emit({ _case: 'close' }); }
    addPhone() {
        const phones = this.editForm.get('phones');
    ...
    getCities(term) {
        return this.salesService
            .getCityByName(term)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(cities => {
            return cities.filter(c => c.city.toLowerCase()
                .indexOf(term.toLowerCase()) > -1).slice(0, 10);
        }));
    }
    getWorkingHour(hours) {
        if (hours) {
            this.editForm
                .get('business_hours')
                .setValue(hours[0]);
...
EditCompnayDetailedModalComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: src_app_sales_service__WEBPACK_IMPORTED_MODULE_3__["SalesService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let JobsContainerComponent = class JobsContainerComponent {
    constructor(activatedRoute, componentFactoryResolver, salesService, router) {
    ...
    ngOnInit() {
        ...
        this.salesService
            .$notification.subscribe(data => { if (data)
            this.getRestult(data); });
        this.salesService.currentCountry = this.params["abbr"];
    }
    getRestult(data) {
        const cp = this.componentFactoryResolver.resolveComponentFactory(_notification_notification_component__WEBPACK_IMPORTED_MODULE_4__["NotificationComponent"]);
...
JobsContainerComponent.ctorParameters = () => [
...
let NewLeadComponent = class NewLeadComponent {
    constructor(salesService) {
        this.salesService = salesService;
        this.companies = null;
        this.amount = 0;
...
NewLeadComponent.ctorParameters = () => [
    { type: src_app_sales_service__WEBPACK_IMPORTED_MODULE_3__["SalesService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let PreSalesComponent = class PreSalesComponent {
    constructor(salesService) {
        this.salesService = salesService;
        this.companies = null;
        this.amount = 0;
...
PreSalesComponent.ctorParameters = () => [
    { type: src_app_sales_service__WEBPACK_IMPORTED_MODULE_3__["SalesService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(src_app_shared_components_app_modal_app_modal_component__WEBPACK_IMPORTED_MODULE_2__["AppModalComponent"], { static: false })
...
let SendEmailModalComponent = class SendEmailModalComponent {
    constructor(salesService, f) {
        this.salesService = salesService;
        this.f = f;
        this.submitted = false;
        this.recivers = [];
        this.result = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.emails = [];
        this.remove = (i) => this.emails.splice(i, 1);
...
SendEmailModalComponent.ctorParameters = () => [
    { type: src_app_sales_service__WEBPACK_IMPORTED_MODULE_3__["SalesService"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let SelectCountryComponent = class SelectCountryComponent {
    constructor() {
...
let SelectJobTypeComponent = class SelectJobTypeComponent {
...
SelectJobTypeComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
...
let LoginComponent = class LoginComponent {
    constructor(salesService, f, router) {
        this.salesService = salesService;
        this.f = f;
        this.router = router;
        this.submitted = false;
...
let SalesService = class SalesService {
    ...
    auth(data) {
        return this.http
            ...
            this.user = Object(_utiles__WEBPACK_IMPORTED_MODULE_6__["parseJWT"])(token);
            return token;
        }));
    }
    getCountries() {
        return this.http
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(el => {
            let data = [];
            for (const key in el) {
                if (key.length === 2) {
    ...
    ;
    getIndustries() {
        return this.http.get('/assets/data/industries.json').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(el => {
            let data = [];
            for (const key in el) {
                data.push({ asc: key, name: el[key] });
            }
     ...
     * @param city_name
     */
    getCityByName(city_name) {
        return this.http
            .get(`/api/graphql/cities/${city_name}`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(el => el["getListOfAllCities"]));
    }
    /**
...
let AppModalComponent = class AppModalComponent {
    ...
    open() {
        setTimeout(() => {
            // @ts-ignore
            this.modalService.open(this.modal, { size: this.size, backdrop: 'static' }).result.then((res) => {
            }, reason => {
                ;
                this.close();
                this.title = '';
...
AppModalComponent.ctorParameters = () => [
...
let BusinesHoursComponent = class BusinesHoursComponent {
    constructor(f, timepickerConfig) {
        this.f = f;
    ...
    ngOnInit() {
        ...
        this.Hours.valueChanges.subscribe((hours) => {
            if (hours && hours.length > 0) {
                this.busniessDate = hours.map((hour) => {
                    ...
                    /// Parse time ///
                    if (hour_from) {
                        let hour = hour_from['hour'] < 10 ? `0${hour_from['hour']}` : hour_from['hour'], minute = hour_from['minute'] < 10 ? `0${hour_from['minute']}` : hour_from['minute'];
                        hour_from = `${hour}:${minute}`;
                    }
                    if (hour_to) {
                        let hour = hour_to['hour'] < 10 ? `0${hour_to['hour']}` : hour_to['hour'], minute = hour_to['minute'] < 10 ? `0${hour_to['minute']}` : hour_to['minute'];
                        hour_to = `${hour}:${minute}`;
                    }
                    return {
                        hour_from,
    ...
    radioTypeChange(e) {
        ...
        if (value === 'open') {
            this.busniessDate.map(date => (date.hour_from = '0:00',
                date.hour_to = '0:00',
    ...
    dateToObject(date) {
        if (date && date !== null) {
            let hour = date ? +date.split(':')[0] : null, minute = date ? +date.split(':')[1] : null;
            return {
                hour,
                minute
            };
...
BusinesHoursComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] },
...
let AuthGuard = class AuthGuard {
    constructor(salesService, router) {
        this.salesService = salesService;
        this.router = router;
    }
...
let DelimetrPipe = class DelimetrPipe {
...
class PasswordValidation {
    ...
    static validateMin(max) {
        return (control) => {
            let value = control.value, parent = control.parent;
            if (!!value) {
...
const YEARS = (function () {
    let currentYear = new Date().getFullYear() - 18, years = [];
